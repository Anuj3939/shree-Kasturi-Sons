        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {businessVerticals.map((vertical) => {
              ...
              return (
                <Card key={vertical.title} className="group hover:shadow-xl transition-all duration-300 bg-white/90 backdrop-blur-sm border-0">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-xl text-brand-800">{vertical.title}</CardTitle>
                  </CardHeader>
